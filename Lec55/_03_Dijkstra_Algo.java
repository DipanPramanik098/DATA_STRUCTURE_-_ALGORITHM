...
// public class _03_Dijkstra_Algo {
//     //single source shortest path - (use BFS terms of edge, terms of cost - dfs)

//     private HashMap<Integer, HashMap<Integer, Integer>> map;

// 	public _03_Dijkstra_Algo(int v) {
// 		map = new HashMap<>();
// 		for (int i = 1; i <= v; i++) {
...
// 		_03_Dijkstra_Algo dj = new _03_Dijkstra_Algo(7);
// 		dj.AddEdge(1, 4, 2);
// 		dj.AddEdge(1, 2, 4);
// 		dj.AddEdge(2, 3, 5);
// 		dj.AddEdge(3, 4, 1);
